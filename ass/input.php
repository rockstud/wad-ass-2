...
<div class="container">
      <div class="row">
		<div class="col-sm-6"><h4>Add a Comment</h4>
		<form name="RegForm" action="output.php" onsubmit="return formvalidatefunc()" method="post">
			<div class="form-group row">
				 <div class="col-sm-6">
				 <input type="text" size=50 name="fName" class="form-control" placeholder="First name">
				</div>
				<div class="col-sm-6">
				 <input type="text" size=50 name="lName" class="form-control" placeholder="last name">
				</div>
			</div>
				<div class="form-group row">
					 <div class="col-sm-12">
					 <input type="text" size=50 name="Email" class="form-control" placeholder="Email">
					</div>
				</div>
			<div class="form-group row"> 
				<div class="col-sm-12">
					<textarea cols="55" name="Comment" class="form-control" placeholder="Message"></textarea>
				</div>
			</div>
            <div class="form-group row"> 
				<div class="col-sm-12">
